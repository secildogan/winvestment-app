// Generated on 2016-08-31 using generator-angular-fullstack 3.0.0-rc8
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    buildcontrol: {
      ...
      heroku: {
        options: {
          remote: 'https://git.heroku.com/winvestment.git',
          branch: 'master'
        }
      },
      openshift: {
    ...
    babel: {
      ...
      server: {
        options: {
          optional: ['runtime'],
          ignore: ['<%= yeoman.server %>/cities', '<%= yeoman.dist %>/server/cities', '<%= yeoman.server %>/settings', '<%= yeoman.dist %>/server/settings', '<%= yeoman.server %>/locales', '<%= yeoman.dist %>/server/locales']
        },
        files: [{
          expand: true,
          cwd: '<%= yeoman.server %>',
